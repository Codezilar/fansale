        ...
        <div className="p-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-yellow-700 space-y-1">
              <li key="instruction-1">• Send exactly £{ticket.price} of BTC</li>
              <li key="instruction-2">• Use Bitcoin Mainnet only</li>
              <li key="instruction-3">• Do not send from exchange wallets</li>
              <li key="instruction-4">• Transaction may take 2-3 minutes to confirm</li>
            </ul>
          </div>
